...
import 'package:ball_knowledge/widgets/product_card.dart';

class MyHomePage extends StatelessWidget {
  MyHomePage({super.key});

  final String nama = "Daffa Ismail"; // Name
  final String npm = "2406434090"; // NPM
  final String kelas = "A"; // Class
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        // Judul aplikasi "Ball Knowledge" dengan teks putih dan tebal.
        title: const Text(
          'Ball Knowledge',
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'Selamat datang di Ball Knowledge',
                      style: TextStyle(
